				...
				<div class="col-md-10 panel panel-default">
					...
					<div class="row">
						<div class="button-group col-md-6">
							...
							<a href="<?php echo site_url().'/csv';?>" class="btn btn-primary" role="button" data-toggle="tooltip" data-placement="bottom" title="Add Batch Data">
								...
								<?php foreach ($document as $row): ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url().'/document/delete_row/'.$row['doc_code'];?>" data-toggle="tooltip" data-placement="bottom" title="Delete">
