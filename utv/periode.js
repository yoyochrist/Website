$(document).ready(function() {
	...
	$('a[data-confirm]').click(function(ev) {
		...
		var competentID = $(this).attr('data-competent');
	        $('#dataConfirmModal').find('.message').text($(this).attr('data-confirm'));
		$('#idClass').attr('value',id);
		$('#competentIdClass').attr('value',competentID);
        	$('#dataConfirmModal').modal({show:true});
		$('#dataConfirmDelete').submit(function() {
			$.ajax({
				url: href,
				type: "post",
				data: $(this).serialize(),
				...
				error: function(result) {
					alert('Menghapus data tidak berhasil!');
				}
			});
...
function getSubjectDropdown()
{
	$.ajax({
		type: 'GET',
		url: 'table.php?f=get_dropdown&id=subject',
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data){
				$.each(data.data, function (i, items) {
					$(".subjectList").append("<option value='"+items.subject_id+"'>"+items.name+"</option>");
				});
			}
		}
	});
...
function getCompetentDropdown()
{
	$.ajax({
		type: 'GET',
		url: 'table.php?f=get_dropdown&id=competent',
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data){
				$.each(data.data, function (i, items) {
					$(".competentList").append("<option value='"+items.competent_id+"'>"+items.name+"</option>");
				});
			}
		}
	});
...
function getCompetencyList(str)
{
	$.ajax({
		type: 'GET',
		url: 'table.php?f=get_competent&id='+str,
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data){
			...
			if(data)
			{
				$.each(data.data, function (i, items) {					
					...
					/*$('#formDeleteCompetent'+str+items.competent_id).submit(function() {
						$.ajax({
							url: "competent.php?f=delete",
							type: "post",
							data: $(this).serialize(),
							success: function(result) {
								$('#comeptentT'+code).empty();
...
function getCompetentData(str, name, count, code)
{
	...
	$.ajax({
		type: 'GET',
		url: 'subject.php?f=get_data&id='+str,
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data)
...
function getCompetentData(str, name, count, code)
{
	...
	$.ajax({
		type: 'GET',
		url: 'competent.php?f=get_data&id='+str,
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data)
...
function getStationData(per_id, sess_id, loc_id, code)
{
	...
	$.ajax({
		type: 'GET',
		url: 'station.php?f=get_data&perid='+per_id+'&sessid='+sess_id+'&locid='+loc_id,
		async: false,
		dataType: 'json',
		success: function (data) {
			if(data){
...
function getLocationData(session_id)
{
	...
	$.ajax({
		type: 'GET',
		url: 'location.php?f=get_data&sessid='+session_id,
		async: false,
		dataType: 'json',
		success: function (data) {
...
function getSessionData(str, name, count)
{
	...
	$.ajax({
		type: 'GET',
		url: 'session.php?f=get_data&pid='+str,
		async: false,
		dataType: 'json',
		success: function (data) {
