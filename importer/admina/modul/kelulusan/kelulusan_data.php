...
if (isset($_POST['status_filter'])) {
	...
	$query = $new_table->get_custom("select * from kelulusan where kode_jurusan='".$_POST['jurusan']."' $status ",$columns);
} else {

$query = $new_table->get_custom("select * from kelulusan where kode_jurusan='".$_POST['jurusan']."'",$columns);
...
foreach ($query	as $value) {
	...
	$ResultData[] = $value->id_jenis_keluar;
