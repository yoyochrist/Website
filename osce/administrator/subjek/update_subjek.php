<?php
	...
	$sql = "SELECT `id`,`name`,`desc` FROM `subject` WHERE `id` = '".$_GET['id']."' LIMIT 1";
...
<form class="form-group col-md-6" action="index.php?mod=subupact" method="post">
	...
	<input class="form-control" type="text" name="desc" value="<?php echo $row[2];?>">
	<input class="form-control" type="hidden" name="id" value="<?php echo $row[0];?>">
	<div class="col-md-6">
		<a class="form-control btn btn-primary" href="index.php?mod=sub">Kembali</a>
	</div>
	<div class="col-md-6">
