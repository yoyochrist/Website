...
$sql="SELECT competent_name,weight,score,comment FROM grade WHERE session_id='$session' AND student_id='$student'";
...
$sql="SELECT sum(score*weight)/sum(3*weight)*100 as nilai,global_scale,global_comment FROM grade WHERE session_id='$session' AND student_id='$student' LIMIT 0, 1";
